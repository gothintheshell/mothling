...
layout: "single" # Optional, but ensures it uses the default single layout
lastmod: 2026-05-22
draft: false
---
...
Where possible I have configured this site to operate with privacy in mind, such as excluding any Google Analytics functionality and preventing embedded services from utilising page data for personalised suggestions and ads. 
...
## Third Party Data Collection (Placeholder)

This website is hosted on [insert provider here], as a part of the hosting provider's security measures, your IP will be logged and stored by [provider], regardless of whether you are signed in with a GitHub account or not. I do not have control over GitHub's security measures but if you would like more information, please see [provider website link].